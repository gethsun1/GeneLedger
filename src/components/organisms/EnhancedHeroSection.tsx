...
const EnhancedHeroSection: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          <motion.div variants={fadeIn} className="space-y-4">
            <motion.h1 
              className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-600 via-teal-600 to-green-600 bg-clip-text text-transparent leading-tight tracking-wide drop-shadow-lg"
            ...
            <motion.p 
              className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed drop-shadow-sm"
          ...
          {/* Enhanced Feature Icons with Glass Cards */}
          <motion.div 
            variants={fadeIn}
          ...
          >
            {[
              ...
              <motion.div
                ...
                custom={index}
              >
                <GlassCard hover intensity="medium" size="sm" className="p-4">
                  <motion.div 
                ...
                <span className="text-sm font-medium text-gray-600 dark:text-gray-400 drop-shadow-sm">
                  {label}
                </span>
              </motion.div>
            ))}
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <EnhancedButton variant="primary" size="lg" glow className="px-8 py-4 text-lg">
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <EnhancedButton variant="glass" size="lg" className="px-8 py-4 text-lg">
                Join the DAO
              </EnhancedButton>
            </motion.div>
          </motion.div>
          ...
          >
            {[
              ...
              >
                <GlassCard hover intensity="light" className="p-6 text-center">
                  <motion.div 
                    className={`text-3xl md:text-4xl font-bold ${stat.color} mb-1 drop-shadow-sm`}
      ...
      >
        <GlassCard intensity="light" size="sm" className="p-2">
          <motion.div 
            className="w-6 h-10 border-2 border-gray-400/50 dark:border-gray-600/50 rounded-full flex justify-center"
            whileHover={{ scale: 1.1 }}
          >
            <motion.div 
              className="w-1 h-3 bg-gradient-to-b from-purple-500 to-teal-500 rounded-full mt-2 shadow-lg"
              animate={{ y: [0, 8, 0] }}
              transition={{ duration: 1.5, repeat: Infinity }}
            />
          </motion.div>
